...
```
cd existing_repo
git remote add origin http://gitlab.localhost/root/first-project.git
git branch -M main
...
- [ ] [Set up project integrations](http://gitlab.localhost/root/first-project/-/settings/integrations)
